...
```
 ...
 ```   
Penginstansian seller yg diambil dari seller.cs untuk diberikan kewenangan untuk mengontrol keranjang dan diisi buah
```
class Seller
{
    private string name;
...
```
class Bucket { private int capacity; private List fruits;
...
class BucketController { private Bucket bucket; private BucketEventListener eventListener;
